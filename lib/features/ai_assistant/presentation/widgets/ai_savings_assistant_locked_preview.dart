...
/// Pro-locked preview shown to Free users on the AI Savings Assistant tab.
///
/// Does not render chat UI or trigger assistant requests.
class AiSavingsAssistantLockedPreview extends StatelessWidget {
  const AiSavingsAssistantLockedPreview({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> benefits = <String>[
      l10n.aiProBenefitPersonalizedRecommendations,
      l10n.aiProBenefitStoreComparisons,
      l10n.aiProBenefitSpendingInsights,
      l10n.aiProBenefitBudgetAnswers,
    ];
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: theme.isDark
                                  ...
                                  : _accentSavings.withOpacity(0.14),
                              shape: BoxShape.circle,
                            ),
                            child: Icon(
                              Icons.check_rounded,
