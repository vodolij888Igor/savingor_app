...
class HomeDashboardScreen extends StatelessWidget {
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const SizedBox(height: SavingorSpacing.md),
                          _buildNearbyStoresMapCta(context),
                          const SizedBox(height: SavingorSpacing.xl),
  ...
  Widget _buildNearbyStoresMapCta(BuildContext context) {
    return Material(
      color: Colors.transparent,
      child: InkWell(
        onTap: () => context.push('/nearby-stores'),
        ...
        child: Ink(
          decoration: BoxDecoration(
            ...
            boxShadow: <BoxShadow>[
              BoxShadow(
                color: SavingorColors.primaryStroke.withOpacity(0.1),
                blurRadius: 14,
            ...
            child: Row(
              children: <Widget>[
                Container(
                  ...
                  height: 48,
                  decoration: BoxDecoration(
                    color: SavingorColors.lightGreen.withOpacity(0.42),
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(
                      color: SavingorColors.primaryStroke.withOpacity(0.18),
                    ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      const SizedBox(height: 4),
                      Text(
                        'Find stores near you, choose a radius, and get directions.',
                        maxLines: 2,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
                          fontSize: 12,
      ...
      children: <Widget>[
        Row(
          children: <Widget>[
            ...
            TextButton(
              onPressed: () => context.push('/nearby-stores'),
    ...
    return SizedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(18),
          border: Border.all(
            color: HomeDashboardScreen._airyBorder.withOpacity(0.6),
            width: 0.5,
          ),
          boxShadow: <BoxShadow>[
            BoxShadow(
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: const TextStyle(
                fontSize: 12,
                fontWeight: FontWeight.w700,
                color: HomeDashboardScreen._nearBlack,
                height: 1.2,
              ),
            ),
