...
class AppSettingsScreen extends StatelessWidget {
              ...
              children: <Widget>[
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: theme.isDark ? theme.textPrimary : _titleCharcoal,
                    height: 1.2,
                    letterSpacing: -0.2,
                  ),
                ),
  ...
  Widget _preferenceDivider(BuildContext context) {
    return Padding(
    ...
    return Container(
      ...
      decoration: theme.isDark
          ...
          : BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(_cardRadius),
              border: Border.all(
                color: theme.border.withOpacity(0.75),
              ),
              boxShadow: const <BoxShadow>[
                BoxShadow(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(
                ...
                size: 22,
                color: context.savingor.textSecondary.withOpacity(0.65),
              ),
            ],
          ),
        ),
